...
public class TransactionServiceTest {
	...
	public void testAddTransactionSuccess() throws Exception {
		...
		when(transactionMapper.toTransactionEntity(transactionDTO)).thenReturn(transaction);
	...
	public void testAddTransactionFailure() throws Exception {
		...
		when(transactionMapper.toTransactionEntity(transactionDTO)).thenThrow(EntityNotPresentException.class);
